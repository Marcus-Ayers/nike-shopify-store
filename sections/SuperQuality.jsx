    ...
    >
      <div className="flex flex-1 flex-col ">
        ...
        <p className="info-text mt-4 lg:max-w-lg">
          ...
          elevate your experience, providing you with unmatch quality, innovation, and a touch of
          elegance.
        </p>
      ...
      <div className="flex flex-1 items-center justify-center ">
        <Image src={shoe8} alt="Shoe" width={570} height={522} className="object-contain" />
      </div>
    </section>
  );
};
