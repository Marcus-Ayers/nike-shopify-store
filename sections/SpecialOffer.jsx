  ...
  return (
    <section className="justify-wrap max-container flex items-center gap-10 max-xl:flex-col-reverse ">
      <div className="flex-1 ">
        <Image src={offer} alt="Image" width={773} height={687} className="w-full object-contain" />
      </div>
      <div className="flex flex-1 flex-col ">
        ...
        <p className="info-text mt-6 lg:max-w-lg">
          Navigate a realm of possibilities designed to fufill your unique desires, surpassing the
          loftiest expections. Your journey with us is nothing short of exceptional.
        </p>
